...
let language ="java secript";
let NumberOfWeek = 2;
let StatusOfMaster = fales;
console.log("Hello, my name is " + MyName + ", and I am learning " + language + ". I have been practicing for only " +  NumberOfWeek + " weeks, so my status as a master is: " + StatusOfMaster+ ".");
